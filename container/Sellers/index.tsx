...
function Sellers() {
  ...
  const {
    ...
    [sellerDataKey, page, rowsPerPage, debouncedSearchQuery],
    ...
    <Layout>
      ...
      {isSellersLoading ? (
        ...
        <>
            ...
            <Table sx={{ minWidth: 700 }} aria-label="customized table">
              <TableHead>
                <TableRow sx={{ fontWeight: 600 }}>
                  ...
                  <StyledTableCell align="right">GST No</StyledTableCell>
                  <StyledTableCell align="right">Shop Address</StyledTableCell>
          ...
          <TablePagination
            component="div"
            count={sellerData?.totalRecords || 0}
            page={page}
            onPageChange={handleChangePage}
            rowsPerPage={sellerData?.recordsPerPage}
